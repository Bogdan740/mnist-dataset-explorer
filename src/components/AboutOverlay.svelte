...
<div class="blur" class:show>
  <section>
    <div class="right">
      <Button onclick={() => (show = false)} primaryStyle>Exit</Button>
    </div>

    <h2>MNIST Explorer - About</h2>
    <p>
    ...
    <h3>Motivation</h3>
    <p>
      This project was completed in two weeks during June 2021 as an exploration
      into team dynamics.
    </p>
